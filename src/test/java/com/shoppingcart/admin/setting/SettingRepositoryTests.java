...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		...
		Setting siteLogo = new Setting("SITE_LOGO", "shopping-logo.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2021 Shopping Ltd.", SettingCategory.GENERAL);
